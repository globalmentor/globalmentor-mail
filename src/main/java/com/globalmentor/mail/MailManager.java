...
public class MailManager {
	...
	/**
	 * Properties constructor. The transport protocol should be specified in the {@value Mail#MAIL_TRANSPORT_PROTOCOL_PROPERTY} property. Besides the default
	 * JavaMail properties, this implementation expects the mail authentication user to be specified in the <code>mail.<var>transport</var>.user</code> property
	...
	public MailManager(final Map<?, ?> properties) throws NoSuchProviderException {
		...
		sendThread = new Thread(mailSender, getClass().getSimpleName()); //create a new send thread
